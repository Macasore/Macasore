...
```text
lang        python · go · java · c
backend     fastapi · django · flask · spring boot
ml          pytorch · tensorflow · scikit-learn · numpy · pandas
data        postgres · mysql · mongodb · redis · elasticsearch · sqlite
infra       aws · gcp · nginx · gunicorn · tomcat · tauri
ops         github actions · gitlab ci · jenkins · sentry · nvidia
```
